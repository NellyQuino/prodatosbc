...
<div class="row justify-content-end">
    ...
    <div class="text-right col-sm-2">
        <button type=" button" class="btn btn-primary" data-bs-toggle="modal" data-toggle="tooltip" title="Subir marca de agua" style="background: #059B97;"><i class="fa fa-file-image-o"></i>
            Marcas de agua
        </button>
    </div>
