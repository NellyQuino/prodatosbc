    ...
    <div class="col-md-12  mt-3">
        ...
        <table class="table table-striped table-bordered" id="myTable">
            ...
            @php
                ...
                <tr>
                    <td style="width:25%;" class="align-top">{{$accion -> estrategia -> problematica-> eje -> number}}</td>
                    <td style="width:25%;" class="align-top">{{$accion -> estrategia -> problematica-> eje -> name}}</td>
                    ...
                    <td style="width:5%;">
                        <a type="button" class="btn btn-primary" style="background: #059B97;" data-toggle="tooltip" title="Editar" href="{{ route('accion.edit', $accion->id) }}"> <i class="fas fa-edit"></i></a>
                    </td>
                    <td style="width:5%;">
                    @php
